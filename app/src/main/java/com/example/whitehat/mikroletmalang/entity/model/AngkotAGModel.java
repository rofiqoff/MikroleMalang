...
public class AngkotAGModel {

    String result;
    String msg;
    List<MikroletAG> mikrolet_ag;
    ...
    public List<MikroletAG> getMikrolet_ag() {
        return mikrolet_ag;
    }

    public void setMikrolet_ag(List<MikroletAG> mikrolet_ag) {
        this.mikrolet_ag = mikrolet_ag;
    }

    public class MikroletAG {
