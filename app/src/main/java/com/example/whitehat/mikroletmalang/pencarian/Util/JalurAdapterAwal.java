...
/**
 * Created by rofiqoff on 8/19/17.
 */

public class JalurAdapterAwal extends ArrayAdapter<JalurAngkot.Jalur> {
    Context context;
    int resource, textViewResourceId1, textViewResourceId2;
    public ArrayList<JalurAngkot.Jalur> address, tempAddress, suggestions;

    private TextView textAlamat;
    private TextView textKoordinat;

    public String nodeJalur, lat, lng, namaJalan;

    public JalurAdapterAwal(Context context, int resource, int textViewResourceId1, int textViewResourceId2, ArrayList<JalurAngkot.Jalur> address){
