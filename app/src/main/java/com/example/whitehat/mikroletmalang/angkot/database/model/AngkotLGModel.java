...
public class AngkotLGModel {
    String result;
    String msg;
    List<MikroletLG> mikrolet_lg;
    ...
    public List<MikroletLG> getMikrolet_lg() {
        return mikrolet_lg;
    }

    public void setMikrolet_lg(List<MikroletLG> mikrolet_lg) {
        this.mikrolet_lg = mikrolet_lg;
    }

    public class MikroletLG {
