package com.example.whitehat.mikroletmalang.pencarian.geolocation;
...
import com.example.whitehat.mikroletmalang.pencarian.geolocation.util.Constants;
...
public class GeocoderIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (mReceiver == null){
            Log.wtf(TAG, "Tidak ada receiver, sehinggal hasil tidak bisa dikirm");
            return;
        }
